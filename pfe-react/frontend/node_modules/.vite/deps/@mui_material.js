...
var GridLegacyContext = React40.createContext();
if (true) {
...
var GridLegacy = React41.forwardRef(function GridLegacy2(inProps, ref) {
  ...
  const columnsContext = React41.useContext(GridLegacyContext_default);
...
var Rating = React68.forwardRef(function Rating2(inProps, ref) {
  const props = useDefaultProps({
    name: "MuiRating",
    props: inProps
  });
  ...
  const [emptyValueFocused, setEmptyValueFocused] = React68.useState(false);
  const ownerState = {
    ...props,
    component,
    defaultValue,
...
var ScopedCssBaseline = React69.forwardRef(function ScopedCssBaseline2(inProps, ref) {
  const props = useDefaultProps({
    props: inProps,
    name: "MuiScopedCssBaseline"
  });
...
function SliderValueLabel(props) {
  ...
  }, (0, import_jsx_runtime63.jsxs)(React71.Fragment, {
...
var Slider = React72.forwardRef(function Slider2(inputProps, ref) {
  ...
  return (0, import_jsx_runtime64.jsxs)(RootSlot, {
    ...
    children: [(0, import_jsx_runtime64.jsx)(RailSlot, {
      ...
      return (0, import_jsx_runtime64.jsxs)(React72.Fragment, {
...
true ? Snackbar.propTypes = {
  ...
  slotProps: import_prop_types58.default.shape({
    clickAwayListener: import_prop_types58.default.oneOfType([import_prop_types58.default.func, import_prop_types58.default.shape({
      children: import_prop_types58.default.element.isRequired,
      disableReactTree: import_prop_types58.default.bool,
      mouseEvent: import_prop_types58.default.oneOf(["onClick", "onMouseDown", "onMouseUp", "onPointerDown", "onPointerUp", false]),
      onClickAway: import_prop_types58.default.func,
      touchEvent: import_prop_types58.default.oneOf(["onTouchEnd", "onTouchStart", false])
    })]),
...
var SpeedDialAction = React78.forwardRef(function SpeedDialAction2(inProps, ref) {
  const props = useDefaultProps({
    props: inProps,
    name: "MuiSpeedDialAction"
  });
  ...
  const [tooltipOpen, setTooltipOpen] = React78.useState(externalForwardedProps.slotProps.tooltip?.open);
...
var SpeedDialIcon = React80.forwardRef(function SpeedDialIcon2(inProps, ref) {
  const props = useDefaultProps({
    props: inProps,
    name: "MuiSpeedDialIcon"
  });
  ...
  function formatIcon(icon, newClassName) {
    if (React80.isValidElement(icon)) {
      return React80.cloneElement(icon, {
...
var StepperContext = React81.createContext({});
if (true) {
  StepperContext.displayName = "StepperContext";
}
function useStepperContext() {
  return React81.useContext(StepperContext);
}
var StepperContext_default = StepperContext;

// node_modules/@mui/material/esm/Step/StepContext.js
var React82 = __toESM(require_react(), 1);
var StepContext = React82.createContext({});
if (true) {
  StepContext.displayName = "StepContext";
}
function useStepContext() {
  return React82.useContext(StepContext);
}
...
var Step = React83.forwardRef(function Step2(inProps, ref) {
  ...
  return (0, import_jsx_runtime72.jsx)(StepContext_default.Provider, {
    value: contextValue,
    children: connector && !alternativeLabel && index !== 0 ? (0, import_jsx_runtime72.jsxs)(React83.Fragment, {
...
var StepIcon = React86.forwardRef(function StepIcon2(inProps, ref) {
  const props = useDefaultProps({
    props: inProps,
    name: "MuiStepIcon"
  });
...
var StepLabel = React87.forwardRef(function StepLabel2(inProps, ref) {
  const props = useDefaultProps({
    props: inProps,
    name: "MuiStepLabel"
  });
...
var StepButton = React88.forwardRef(function StepButton2(inProps, ref) {
  const props = useDefaultProps({
    props: inProps,
    name: "MuiStepButton"
  });
  ...
  const child = isMuiElement_default(children, ["StepLabel"]) ? React88.cloneElement(children, childProps) : (0, import_jsx_runtime77.jsx)(StepLabel_default, {
    ...childProps,
    children
  });
...
var StepConnector = React89.forwardRef(function StepConnector2(inProps, ref) {
  const props = useDefaultProps({
    props: inProps,
    name: "MuiStepConnector"
  });
...
var StepContent = React90.forwardRef(function StepContent2(inProps, ref) {
  const props = useDefaultProps({
    props: inProps,
    name: "MuiStepContent"
  });
...
var Stepper = React91.forwardRef(function Stepper2(inProps, ref) {
  const props = useDefaultProps({
    props: inProps,
    name: "MuiStepper"
  });
  ...
  const childrenArray = React91.Children.toArray(children).filter(Boolean);
  const steps = childrenArray.map((step, index) => {
    return React91.cloneElement(step, {
      index,
...
var SwipeArea = React92.forwardRef(function SwipeArea2(props, ref) {
  const {
    anchor,
    classes = {},
    className,
...
var SwipeableDrawer = React93.forwardRef(function SwipeableDrawer2(inProps, ref) {
  const props = useDefaultProps({
  ...
  const [maybeSwiping, setMaybeSwiping] = React93.useState(false);
  const swipeInstance = React93.useRef({
    isSwiping: null
  });
  const swipeAreaRef = React93.useRef();
  const backdropRef = React93.useRef();
  const paperRef = React93.useRef();
  const handleRef = useForkRef_default(PaperProps.ref, paperRef);
  const touchDetected = React93.useRef(false);
  const calculatedDurationRef = React93.useRef();
  useEnhancedEffect_default2(() => {
    calculatedDurationRef.current = null;
  }, [open]);
  const setPosition = React93.useCallback((translate, options = {}) => {
    const {
      mode = null,
...
var Switch = React94.forwardRef(function Switch2(inProps, ref) {
  const props = useDefaultProps({
    props: inProps,
    name: "MuiSwitch"
  });
...
true ? Switch.propTypes = {
  ...
  slotProps: import_prop_types73.default.shape({
    input: import_prop_types73.default.oneOfType([import_prop_types73.default.func, import_prop_types73.default.object]),
    root: import_prop_types73.default.oneOfType([import_prop_types73.default.func, import_prop_types73.default.object]),
    switchBase: import_prop_types73.default.oneOfType([import_prop_types73.default.func, import_prop_types73.default.object]),
    thumb: import_prop_types73.default.oneOfType([import_prop_types73.default.func, import_prop_types73.default.object]),
    track: import_prop_types73.default.oneOfType([import_prop_types73.default.func, import_prop_types73.default.object])
  }),
  /**
   * The components used for each slot inside.
   * @default {}
  ...
  slots: import_prop_types73.default.shape({
    ...
    switchBase: import_prop_types73.default.elementType,
    thumb: import_prop_types73.default.elementType,
    track: import_prop_types73.default.elementType
  }),
  /**
   * The system prop that allows defining system overrides as well as additional CSS styles.
   */
...
var Tab = React95.forwardRef(function Tab2(inProps, ref) {
  ...
  return (0, import_jsx_runtime84.jsxs)(TabRoot, {
    ...
    ...other,
    children: [iconPosition === "top" || iconPosition === "start" ? (0, import_jsx_runtime84.jsxs)(React95.Fragment, {
      children: [icon, label]
    }) : (0, import_jsx_runtime84.jsxs)(React95.Fragment, {
      children: [label, icon]
    }), indicator]
  });
});
true ? Tab.propTypes = {
   ...
   * The icon to display.
   */
  icon: import_prop_types74.default.oneOfType([import_prop_types74.default.element, import_prop_types74.default.string]),
  /**
   * The position of the icon relative to the label.
   * @default 'top'
   */
  iconPosition: import_prop_types74.default.oneOf(["bottom", "end", "start", "top"]),
  /**
   * The label element.
   */
   ...
   * @default false
   */
  wrapped: import_prop_types74.default.bool
} : void 0;
var Tab_default = Tab;
...
var TableBody = React97.forwardRef(function TableBody2(inProps, ref) {
  const props = useDefaultProps({
    props: inProps,
    name: "MuiTableBody"
  });
...
var TableContainer = React98.forwardRef(function TableContainer2(inProps, ref) {
  const props = useDefaultProps({
    props: inProps,
    name: "MuiTableContainer"
  });
...
var TableFooter = React99.forwardRef(function TableFooter2(inProps, ref) {
  const props = useDefaultProps({
    props: inProps,
    name: "MuiTableFooter"
  });
...
var TableHead = React100.forwardRef(function TableHead2(inProps, ref) {
  const props = useDefaultProps({
    props: inProps,
    name: "MuiTableHead"
  });
...
var TableRow = React101.forwardRef(function TableRow2(inProps, ref) {
  ...
  return (0, import_jsx_runtime90.jsx)(TableRowRoot, {
    as: component,
    ref,
    className: clsx_default(classes.root, className),
...
var ArrowDownward_default = createSvgIcon((0, import_jsx_runtime91.jsx)("path", {
...
var TableSortLabel = React103.forwardRef(function TableSortLabel2(inProps, ref) {
  ...
  return (0, import_jsx_runtime92.jsxs)(RootSlot, {
    ...
    ...rootProps,
    ...other,
    children: [children, hideSortIcon && !active ? null : (0, import_jsx_runtime92.jsx)(IconSlot, {
      as: IconComponent,
      ...iconProps
    })]
  });
...
var TabScrollButton = React105.forwardRef(function TabScrollButton2(inProps, ref) {
  ...
  return (0, import_jsx_runtime94.jsx)(TabScrollButtonRoot, {
    component: "div",
    className: clsx_default(classes.root, className),
    ref,
    role: null,
    ...
    children: direction === "left" ? (0, import_jsx_runtime94.jsx)(StartButtonIcon, {
      ...startButtonIconProps
    }) : (0, import_jsx_runtime94.jsx)(EndButtonIcon, {
      ...endButtonIconProps
    })
  });
});
...
var Tabs = React106.forwardRef(function Tabs2(inProps, ref) {
  ...
  const getConditionalElements = () => {
    ...
    conditionalElements2.scrollbarSizeListener = scrollable ? (0, import_jsx_runtime95.jsx)(ScrollbarSlot, {
      ...scrollbarSlotProps,
      onChange: handleScrollbarSizeChange
    }) : null;
    const scrollButtonsActive = displayStartScroll || displayEndScroll;
    const showScrollButtons = scrollable && (scrollButtons === "auto" && scrollButtonsActive || scrollButtons === true);
    conditionalElements2.scrollButtonStart = showScrollButtons ? (0, import_jsx_runtime95.jsx)(ScrollButtonsSlot, {
      direction: isRtl ? "right" : "left",
      onClick: handleStartScrollClick,
      disabled: !displayStartScroll,
      ...scrollButtonSlotProps
    }) : null;
    conditionalElements2.scrollButtonEnd = showScrollButtons ? (0, import_jsx_runtime95.jsx)(ScrollButtonsSlot, {
  ...
  const indicator = (0, import_jsx_runtime95.jsx)(IndicatorSlot, {
    ...indicatorSlotProps
  });
  let childIndex = 0;
  ...
  return (0, import_jsx_runtime95.jsxs)(RootSlot, {
    ...rootSlotProps,
    children: [conditionalElements.scrollButtonStart, conditionalElements.scrollbarSizeListener, (0, import_jsx_runtime95.jsxs)(ScrollerSlot, {
      ...scrollerSlotProps,
      children: [(0, import_jsx_runtime95.jsx)(ListSlot, {
        "aria-label": ariaLabel,
        "aria-labelledby": ariaLabelledBy,
...
true ? Tabs.propTypes = {
  ...
  slotProps: import_prop_types84.default.shape({
    ...
    indicator: import_prop_types84.default.oneOfType([import_prop_types84.default.func, import_prop_types84.default.object]),
    list: import_prop_types84.default.oneOfType([import_prop_types84.default.func, import_prop_types84.default.object]),
    root: import_prop_types84.default.oneOfType([import_prop_types84.default.func, import_prop_types84.default.object]),
    scrollbar: import_prop_types84.default.oneOfType([import_prop_types84.default.func, import_prop_types84.default.object]),
    scrollButtons: import_prop_types84.default.oneOfType([import_prop_types84.default.func, import_prop_types84.default.object]),
    scroller: import_prop_types84.default.oneOfType([import_prop_types84.default.func, import_prop_types84.default.object]),
  ...
  slots: import_prop_types84.default.shape({
    ...
    EndScrollButtonIcon: import_prop_types84.default.elementType,
    indicator: import_prop_types84.default.elementType,
    list: import_prop_types84.default.elementType,
    root: import_prop_types84.default.elementType,
    scrollbar: import_prop_types84.default.elementType,
    scrollButtons: import_prop_types84.default.elementType,
    scroller: import_prop_types84.default.elementType,
...
var ToggleButtonGroupContext = React107.createContext({});
if (true) {
...
var ToggleButtonGroupButtonContext = React108.createContext(void 0);
if (true) {
...
var ToggleButton = React109.forwardRef(function ToggleButton2(inProps, ref) {
  const {
    value: contextValue,
    ...contextProps
  } = React109.useContext(ToggleButtonGroupContext_default);
  const toggleButtonGroupButtonContextPositionClassName = React109.useContext(ToggleButtonGroupButtonContext_default);
...
true ? ToggleButton.propTypes = {
   ...
   * ToggleButtonGroup.
   */
  value: import_prop_types85.default.any.isRequired
} : void 0;
...
var ToggleButtonGroup = React110.forwardRef(function ToggleButtonGroup2(inProps, ref) {
  ...
  const handleChange = React110.useCallback((event, buttonValue) => {
    if (!onChange) {
      return;
    }
  ...
  const handleExclusiveChange = React110.useCallback((event, buttonValue) => {
    if (!onChange) {
      return;
    }
    onChange(event, value === buttonValue ? null : buttonValue);
  }, [onChange, value]);
  const context = React110.useMemo(() => ({
    className: classes.grouped,
...
true ? ToggleButtonGroup.propTypes = {
   ...
   * @default false
   */
  exclusive: import_prop_types86.default.bool,
  /**
