...
true ? CircularProgress.propTypes = {
   ...
   * @default false
   */
  disableShrink: chainPropTypes(import_prop_types9.default.bool, (props) => {
   ...
   * @default 40
   */
  size: import_prop_types9.default.oneOfType([import_prop_types9.default.number, import_prop_types9.default.string]),
  /**
   * @ignore
   */
   ...
   */
  variant: import_prop_types9.default.oneOf(["determinate", "indeterminate"])
} : void 0;
...
function useAutocomplete(props) {
  ...
  const [focusedItem, setFocusedItem] = React17.useState(-1);
  const defaultHighlighted = autoHighlight ? 0 : -1;
  const highlightedIndexRef = React17.useRef(defaultHighlighted);
  const initialInputValue = React17.useRef(getInputValue(defaultValue ?? valueProp, multiple, getOptionLabel)).current;
  ...
  const resetInputValue = React17.useCallback((event, newValue, reason) => {
...
var Portal = React18.forwardRef(function Portal2(props, forwardedRef) {
  ...
  return mountNode ? ReactDOM2.createPortal(children2, mountNode) : mountNode;
});
...
var PopperTooltip = React19.forwardRef(function PopperTooltip2(props, forwardedRef) {
  ...
  useEnhancedEffect_default(() => {
    ...
    const popper = createPopper2(resolvedAnchorElement, tooltipRef.current, {
...
var TextareaAutosize = React24.forwardRef(function TextareaAutosize2(props, forwardedRef) {
  const {
    onChange,
    maxRows,
    minRows = 1,
  ...
  const heightRef = React24.useRef(null);
  const hiddenTextareaRef = React24.useRef(null);
  const calculateTextareaStyles = React24.useCallback(() => {
  ...
  const syncHeight = React24.useCallback(() => {
    const textarea = textareaRef.current;
    const textareaStyles = calculateTextareaStyles();
    if (!textarea || !textareaStyles || isEmpty(textareaStyles)) {
      return;
  ...
  const frameRef = React24.useRef(-1);
  useEnhancedEffect_default(() => {
  ...
  return (0, import_jsx_runtime17.jsxs)(React24.Fragment, {
    children: [(0, import_jsx_runtime17.jsx)("textarea", {
      value,
      ...
      style,
      ...other
    }), (0, import_jsx_runtime17.jsx)("textarea", {
      "aria-hidden": true,
...
var InputBase = React27.forwardRef(function InputBase2(inProps, ref) {
  ...
  return (0, import_jsx_runtime18.jsxs)(React27.Fragment, {
    ...
    (_InputGlobalStyles || (_InputGlobalStyles = (0, import_jsx_runtime18.jsx)(InputGlobalStyles, {}))), (0, import_jsx_runtime18.jsxs)(Root, {
      ...rootProps,
      ref,
      onClick: handleClick,
      ...other,
      ...
      children: [startAdornment, (0, import_jsx_runtime18.jsx)(FormControlContext_default.Provider, {
        value: null,
        children: (0, import_jsx_runtime18.jsx)(Input3, {
...
var Autocomplete = React30.forwardRef(function Autocomplete2(inProps, ref) {
  const props = useDefaultProps({
    props: inProps,
    name: "MuiAutocomplete"
  });
...
true ? Autocomplete.propTypes = {
   ...
   * @default false
   */
  autoComplete: import_prop_types19.default.bool,
  /**
   * If `true`, the first option is automatically highlighted.
   * @default false
   */
  autoHighlight: import_prop_types19.default.bool,
  /**
   ...
   * @default false
   */
  autoSelect: import_prop_types19.default.bool,
  /**
   ...
   * @default false
   */
  blurOnSelect: import_prop_types19.default.oneOfType([import_prop_types19.default.oneOf(["mouse", "touch"]), import_prop_types19.default.bool]),
  /**
   * Props applied to the [`Chip`](https://mui.com/material-ui/api/chip/) element.
   * @deprecated Use `slotProps.chip` instead. This prop will be removed in a future major release. See [Migrating from deprecated APIs](/material-ui/migration/migrating-from-deprecated-apis/) for more details.
   */
  ChipProps: import_prop_types19.default.object,
  /**
   * Override or extend the styles applied to the component.
   */
   ...
   */
  clearIcon: import_prop_types19.default.node,
  /**
   ...
   */
  clearOnBlur: import_prop_types19.default.bool,
  /**
   * If `true`, clear all values when the user presses escape and the popup is closed.
   * @default false
   */
  clearOnEscape: import_prop_types19.default.bool,
  /**
   ...
   * @default 'Clear'
   */
  clearText: import_prop_types19.default.string,
  /**
  ...
  componentsProps: import_prop_types19.default.shape({
    clearIndicator: import_prop_types19.default.object,
    paper: import_prop_types19.default.object,
    popper: import_prop_types19.default.object,
    popupIndicator: import_prop_types19.default.object
  }),
  /**
   * The default value. Use when the component is not controlled.
   * @default props.multiple ? [] : null
   */
  defaultValue: chainPropTypes(import_prop_types19.default.any, (props) => {
   ...
   * @default false
   */
  disableClearable: import_prop_types19.default.bool,
  /**
   * If `true`, the popup won't close when a value is selected.
   * @default false
   */
  disableCloseOnSelect: import_prop_types19.default.bool,
  /**
   * If `true`, the component is disabled.
   * @default false
   */
   ...
   * @returns {Value[]}
   */
  filterOptions: import_prop_types19.default.func,
  /**
   * If `true`, hide the selected options from the list box.
   * @default false
   */
  filterSelectedOptions: import_prop_types19.default.bool,
  /**
   * Force the visibility display of the popup icon.
   * @default 'auto'
   */
  forcePopupIcon: import_prop_types19.default.oneOfType([import_prop_types19.default.oneOf(["auto"]), import_prop_types19.default.bool]),
  /**
   * If `true`, the Autocomplete is free solo, meaning that the user input is not bound to provided options.
   * @default false
   */
  freeSolo: import_prop_types19.default.bool,
  /**
   * If `true`, the input will take up the full width of its container.
   * @default false
   */
   ...
   * @default (more) => `+${more}`
   */
  getLimitTagsText: import_prop_types19.default.func,
  /**
   ...
   * @returns {boolean}
   */
  getOptionDisabled: import_prop_types19.default.func,
  /**
   ...
   */
  getOptionKey: import_prop_types19.default.func,
  /**
   ...
   */
  getOptionLabel: import_prop_types19.default.func,
  /**
   ...
   * @returns {string}
   */
  groupBy: import_prop_types19.default.func,
  /**
   * If `true`, the component handles the "Home" and "End" keys when the popup is open.
   * It should move focus to the first option and last option, respectively.
   * @default !props.freeSolo
   */
  handleHomeEndKeys: import_prop_types19.default.bool,
  /**
   ...
   * @default false
   */
  includeInputInList: import_prop_types19.default.bool,
  /**
   * The input value.
   */
  inputValue: import_prop_types19.default.string,
  /**
   ...
   * @returns {boolean}
   */
  isOptionEqualToValue: import_prop_types19.default.func,
  /**
   ...
   */
  ListboxComponent: import_prop_types19.default.elementType,
  /**
   * Props applied to the Listbox element.
   * @deprecated Use `slotProps.listbox` instead. This prop will be removed in a future major release. See [Migrating from deprecated APIs](/material-ui/migration/migrating-from-deprecated-apis/) for more details.
   */
  ListboxProps: import_prop_types19.default.object,
  /**
   ...
   * @default 'Loading…'
   */
  loadingText: import_prop_types19.default.node,
  /**
   ...
   * @default 'No options'
   */
  noOptionsText: import_prop_types19.default.node,
  /**
   ...
   * @default false
   */
  openOnFocus: import_prop_types19.default.bool,
  /**
   ...
   * @default 'Open'
   */
  openText: import_prop_types19.default.string,
  /**
   * A list of options that will be shown in the Autocomplete.
   */
  options: import_prop_types19.default.array.isRequired,
  /**
   ...
   */
  PopperComponent: import_prop_types19.default.elementType,
  /**
   * The icon to display in place of the default popup icon.
   * @default <ArrowDropDownIcon />
   */
  popupIcon: import_prop_types19.default.node,
  /**
   ...
   * @returns {ReactNode}
   */
  renderGroup: import_prop_types19.default.func,
  /**
   * Render the input.
   *
   * @param {object} params
   ...
   * @returns {ReactNode}
   */
  renderOption: import_prop_types19.default.func,
  /**
   ...
   * @returns {ReactNode}
   */
  renderTags: import_prop_types19.default.func,
  /**
   ...
   * @default !props.freeSolo
   */
  selectOnFocus: import_prop_types19.default.bool,
  /**
   * The size of the component.
   * @default 'medium'
   */
  ...
  slotProps: import_prop_types19.default.shape({
    chip: import_prop_types19.default.oneOfType([import_prop_types19.default.func, import_prop_types19.default.object]),
    clearIndicator: import_prop_types19.default.oneOfType([import_prop_types19.default.func, import_prop_types19.default.object]),
    ...
    popupIndicator: import_prop_types19.default.oneOfType([import_prop_types19.default.func, import_prop_types19.default.object])
  }),
  /**
   * The components used for each slot inside.
   * @default {}
   ...
   */
  value: chainPropTypes(import_prop_types19.default.any, (props) => {
...
var Fade = React31.forwardRef(function Fade2(props, ref) {
  const theme = useTheme();
...
var Backdrop = React32.forwardRef(function Backdrop2(inProps, ref) {
  const props = useDefaultProps({
    props: inProps,
    name: "MuiBackdrop"
  });
  ...
  return (0, import_jsx_runtime23.jsx)(TransitionSlot, {
    in: open,
    timeout: transitionDuration,
    ...other,
    ...transitionProps,
    children: (0, import_jsx_runtime23.jsx)(RootSlot, {
      "aria-hidden": true,
      ...rootProps,
      classes,
      ref,
...
var Badge = React33.forwardRef(function Badge2(inProps, ref) {
  ...
  const rootProps = useSlotProps_default({
    ...
    ownerState,
    className: clsx_default(rootSlotProps?.className, classes.root, className)
  });
  const badgeProps = useSlotProps_default({
    elementType: BadgeSlot,
    externalSlotProps: badgeSlotProps,
    ownerState,
    className: clsx_default(classes.badge, badgeSlotProps?.className)
  });
  return (0, import_jsx_runtime24.jsxs)(RootSlot, {
    ...rootProps,
    children: [children2, (0, import_jsx_runtime24.jsx)(BadgeSlot, {
      ...badgeProps,
...
true ? Badge.propTypes = {
  ...
  anchorOrigin: import_prop_types22.default.shape({
    horizontal: import_prop_types22.default.oneOf(["left", "right"]),
    vertical: import_prop_types22.default.oneOf(["bottom", "top"])
  }),
  /**
   * The content rendered within the badge.
   */
  badgeContent: import_prop_types22.default.node,
  /**
  ...
  components: import_prop_types22.default.shape({
    Badge: import_prop_types22.default.elementType,
  ...
  componentsProps: import_prop_types22.default.shape({
    badge: import_prop_types22.default.oneOfType([import_prop_types22.default.func, import_prop_types22.default.object]),
   ...
   * @default 'rectangular'
   */
  overlap: import_prop_types22.default.oneOf(["circular", "rectangular"]),
  /**
   * Controls whether the badge is hidden when `badgeContent` is zero.
   * @default false
   */
  showZero: import_prop_types22.default.bool,
  /**
   ...
   * @default 'standard'
   */
  variant: import_prop_types22.default.oneOfType([import_prop_types22.default.oneOf(["dot", "standard"]), import_prop_types22.default.string])
} : void 0;
...
var Button = React36.forwardRef(function Button2(inProps, ref) {
  ...
  const loadingId = useId_default(idProp);
  const loadingIndicator = loadingIndicatorProp ?? (0, import_jsx_runtime25.jsx)(CircularProgress_default, {
    "aria-labelledby": loadingId,
    color: "inherit",
    size: 16
  });
  ...
  const startIcon = (startIconProp || loading && loadingPosition === "start") && (0, import_jsx_runtime25.jsx)(ButtonStartIcon, {
    className: classes.startIcon,
    ownerState,
    children: startIconProp || (0, import_jsx_runtime25.jsx)(ButtonLoadingIconPlaceholder, {
      className: classes.loadingIconPlaceholder,
      ownerState
    })
  });
  const endIcon = (endIconProp || loading && loadingPosition === "end") && (0, import_jsx_runtime25.jsx)(ButtonEndIcon, {
    className: classes.endIcon,
    ownerState,
    children: endIconProp || (0, import_jsx_runtime25.jsx)(ButtonLoadingIconPlaceholder, {
      className: classes.loadingIconPlaceholder,
      ownerState
    })
  });
  ...
  const loader = typeof loading === "boolean" ? (
    ...
    (0, import_jsx_runtime25.jsx)("span", {
      ...
      children: loading && (0, import_jsx_runtime25.jsx)(ButtonLoadingIndicator, {
        className: classes.loadingIndicator,
        ownerState,
  ...
  return (0, import_jsx_runtime25.jsxs)(ButtonRoot, {
    ownerState,
...
function ClickAwayListener(props) {
  ...
  return React42.cloneElement(children2, childrenProps);
}
...
function FocusTrap(props) {
  ...
  return (0, import_jsx_runtime31.jsxs)(React43.Fragment, {
    ...
    }), React43.cloneElement(children2, {
      ref: handleRef,
      onFocus
...
function useModal(parameters) {
  ...
  const getTransitionProps2 = () => {
    ...
    return {
      onEnter: createChainedFunction(handleEnter, children2?.props.onEnter ?? noop),
      onExited: createChainedFunction(handleExited, children2?.props.onExited ?? noop)
    };
  };
  return {
    getRootProps,
...
var Modal = React45.forwardRef(function Modal2(inProps, ref) {
  const props = useDefaultProps({
    name: "MuiModal",
    props: inProps
  });
  ...
  return (0, import_jsx_runtime32.jsx)(Portal_default, {
    ref: portalRef,
    container,
    disablePortal,
    children: (0, import_jsx_runtime32.jsxs)(RootSlot, {
      ...rootProps,
      children: [!hideBackdrop && BackdropComponent ? (0, import_jsx_runtime32.jsx)(BackdropSlot, {
        ...backdropProps
      }) : null, (0, import_jsx_runtime32.jsx)(FocusTrap_default, {
        disableEnforceFocus,
        disableAutoFocus,
        disableRestoreFocus,
        isEnabled: isTopModal,
        open,
        children: React45.cloneElement(children2, childProps)
      })]
    })
  });
});
true ? Modal.propTypes = {
   ...
   */
  onTransitionEnter: import_prop_types28.default.func,
  /**
   * A function called when a transition has exited.
   */
  onTransitionExited: import_prop_types28.default.func,
  /**
   * If `true`, the component is shown.
   */
...
var Divider = React46.forwardRef(function Divider2(inProps, ref) {
  ...
  return (0, import_jsx_runtime33.jsx)(DividerRoot, {
    ...
    ...other,
    children: children2 ? (0, import_jsx_runtime33.jsx)(DividerWrapper, {
...
var FormControl = React48.forwardRef(function FormControl2(inProps, ref) {
  ...
  const [adornedStart, setAdornedStart] = React48.useState(() => {
    ...
    if (children2) {
      React48.Children.forEach(children2, (child) => {
  ...
  return (0, import_jsx_runtime35.jsx)(FormControlContext_default.Provider, {
    value: childContext,
    children: (0, import_jsx_runtime35.jsx)(FormControlRoot, {
      as: component,
      ownerState,
      className: clsx_default(classes.root, className),
      ref,
...
var FormControlLabel = React49.forwardRef(function FormControlLabel2(inProps, ref) {
  ...
  if (label != null && label.type !== Typography_default && !disableTypography) {
    label = (0, import_jsx_runtime36.jsx)(TypographySlot, {
      component: "span",
      ...typographySlotProps,
  ...
  return (0, import_jsx_runtime36.jsxs)(FormControlLabelRoot, {
    className: clsx_default(classes.root, className),
    ownerState,
    ref,
    ...other,
    children: [React49.cloneElement(control, controlProps), required ? (0, import_jsx_runtime36.jsxs)("div", {
      children: [label, (0, import_jsx_runtime36.jsxs)(AsteriskComponent, {
        ownerState,
        "aria-hidden": true,
...
true ? FormControlLabel.propTypes = {
  ...
  componentsProps: import_prop_types32.default.shape({
    typography: import_prop_types32.default.object
  }),
  /**
   * A control element. For instance, it can be a `Radio`, a `Switch` or a `Checkbox`.
   */
  control: import_prop_types32.default.element.isRequired,
  /**
   ...
   * @default 'end'
   */
  labelPlacement: import_prop_types32.default.oneOf(["bottom", "end", "start", "top"]),
  /**
   * @ignore
   */
  ...
  slotProps: import_prop_types32.default.shape({
    typography: import_prop_types32.default.oneOfType([import_prop_types32.default.func, import_prop_types32.default.object])
  }),
  /**
   * The components used for each slot inside.
   * @default {}
  ...
  slots: import_prop_types32.default.shape({
    typography: import_prop_types32.default.elementType
  }),
  /**
   * The system prop that allows defining system overrides as well as additional CSS styles.
   */
...
var FormHelperText = React50.forwardRef(function FormHelperText2(inProps, ref) {
  const props = useDefaultProps({
    props: inProps,
    name: "MuiFormHelperText"
  });
  ...
  return (0, import_jsx_runtime37.jsx)(FormHelperTextRoot, {
    as: component,
    className: clsx_default(classes.root, className),
    ref,
    ...other,
    ...
    children: children2 === " " ? (
      ...
      _span || (_span = (0, import_jsx_runtime37.jsx)("span", {
...
var Grow = React52.forwardRef(function Grow2(props, ref) {
  const {
    addEndListener,
    appear = true,
    children: children2,
  ...
  const autoTimeout = React52.useRef();
  const theme = useTheme();
...
var Input = React53.forwardRef(function Input2(inProps, ref) {
  const props = useDefaultProps({
    props: inProps,
    name: "MuiInput"
  });
...
var InputAdornment = React54.forwardRef(function InputAdornment2(inProps, ref) {
  ...
  return (0, import_jsx_runtime41.jsx)(FormControlContext_default.Provider, {
    value: null,
    children: (0, import_jsx_runtime41.jsx)(InputAdornmentRoot, {
      as: component,
      ownerState,
      className: clsx_default(classes.root, className),
      ref,
      ...other,
      children: typeof children2 === "string" && !disableTypography ? (0, import_jsx_runtime41.jsx)(Typography_default, {
        color: "textSecondary",
        children: children2
      }) : (0, import_jsx_runtime41.jsxs)(React54.Fragment, {
        children: [position === "start" ? (
          /* notranslate needed while Google Translate will not fix zero-width space issue */
          _span2 || (_span2 = (0, import_jsx_runtime41.jsx)("span", {
            className: "notranslate",
            "aria-hidden": true,
            children: "​"
          }))
...
var InputLabel = React55.forwardRef(function InputLabel2(inProps, ref) {
  const props = useDefaultProps({
    name: "MuiInputLabel",
    props: inProps
  });
  ...
  return (0, import_jsx_runtime42.jsx)(InputLabelRoot, {
    "data-shrink": shrink,
    ref,
    className: clsx_default(classes.root, className),
    ...other,
...
var ListContext = React57.createContext({});
if (true) {
...
var List = React58.forwardRef(function List2(inProps, ref) {
  const props = useDefaultProps({
    props: inProps,
    name: "MuiList"
  });
  ...
  return (0, import_jsx_runtime44.jsx)(ListContext_default.Provider, {
    value: context,
    children: (0, import_jsx_runtime44.jsxs)(ListRoot, {
      as: component,
      className: clsx_default(classes.root, className),
      ref,
      ownerState,
...
var ListItemIcon = React59.forwardRef(function ListItemIcon2(inProps, ref) {
  ...
  return (0, import_jsx_runtime45.jsx)(ListItemIconRoot, {
    className: clsx_default(classes.root, className),
    ownerState,
    ref,
    ...other
...
var ListItemText = React60.forwardRef(function ListItemText2(inProps, ref) {
  ...
  if (primary != null && primary.type !== Typography_default && !disableTypography) {
    primary = (0, import_jsx_runtime46.jsx)(PrimarySlot, {
  ...
  if (secondary != null && secondary.type !== Typography_default && !disableTypography) {
    secondary = (0, import_jsx_runtime46.jsx)(SecondarySlot, {
      variant: "body2",
      color: "textSecondary",
      ...secondarySlotProps,
      children: secondary
...
true ? ListItemText.propTypes = {
   ...
   * @default false
   */
  inset: import_prop_types42.default.bool,
  /**
   * The main content element.
   */
  primary: import_prop_types42.default.node,
  /**
   * These props will be forwarded to the primary typography component
   * (as long as disableTypography is not `true`).
   * @deprecated Use `slotProps.primary` instead. This prop will be removed in a future major release. See [Migrating from deprecated APIs](/material-ui/migration/migrating-from-deprecated-apis/) for more details.
   */
  primaryTypographyProps: import_prop_types42.default.object,
  /**
   * The secondary content element.
   */
  secondary: import_prop_types42.default.node,
  /**
   * These props will be forwarded to the secondary typography component
   * (as long as disableTypography is not `true`).
   * @deprecated Use `slotProps.secondary` instead. This prop will be removed in a future major release. See [Migrating from deprecated APIs](/material-ui/migration/migrating-from-deprecated-apis/) for more details.
   */
  secondaryTypographyProps: import_prop_types42.default.object,
  /**
   * The props used for each slot inside.
   * @default {}
   */
  slotProps: import_prop_types42.default.shape({
    primary: import_prop_types42.default.oneOfType([import_prop_types42.default.func, import_prop_types42.default.object]),
    root: import_prop_types42.default.oneOfType([import_prop_types42.default.func, import_prop_types42.default.object]),
    secondary: import_prop_types42.default.oneOfType([import_prop_types42.default.func, import_prop_types42.default.object])
  }),
  /**
   * The components used for each slot inside.
   * @default {}
  ...
  slots: import_prop_types42.default.shape({
    primary: import_prop_types42.default.elementType,
    root: import_prop_types42.default.elementType,
    secondary: import_prop_types42.default.elementType
  }),
  /**
   * The system prop that allows defining system overrides as well as additional CSS styles.
   */
...
var MenuList = React61.forwardRef(function MenuList2(props, ref) {
  const {
    // private
    // eslint-disable-next-line react/prop-types
    actions,
  ...
  React61.Children.forEach(children2, (child, index) => {
  ...
  const items = React61.Children.map(children2, (child, index) => {
    if (index === activeItemIndex) {
      ...
      return React61.cloneElement(child, newChildProps);
    }
    return child;
  });
  return (0, import_jsx_runtime47.jsx)(List_default, {
    role: "menu",
    ref: handleRef,
    className,
    onKeyDown: handleKeyDown,
...
var Popover = React62.forwardRef(function Popover2(inProps, ref) {
  const props = useDefaultProps({
    props: inProps,
    name: "MuiPopover"
  });
  ...
  const [isPositioned, setIsPositioned] = React62.useState(open);
  ...
  return (0, import_jsx_runtime48.jsx)(RootSlot, {
    ...
    children: (0, import_jsx_runtime48.jsx)(TransitionSlot, {
      ...transitionSlotProps,
      timeout: transitionDuration,
      children: (0, import_jsx_runtime48.jsx)(PaperSlot, {
        ...paperProps,
        children: children2
      })
    })
...
true ? Popover.propTypes = {
   ...
   */
  anchorEl: chainPropTypes(import_prop_types44.default.oneOfType([HTMLElementType, import_prop_types44.default.func]), (props) => {
  ...
  anchorOrigin: import_prop_types44.default.shape({
    horizontal: import_prop_types44.default.oneOfType([import_prop_types44.default.oneOf(["center", "left", "right"]), import_prop_types44.default.number]).isRequired,
    vertical: import_prop_types44.default.oneOfType([import_prop_types44.default.oneOf(["bottom", "center", "top"]), import_prop_types44.default.number]).isRequired
  }),
  /**
   * This is the position that may be used to set the position of the popover.
   * The coordinates are relative to the application's client area.
   */
  anchorPosition: import_prop_types44.default.shape({
   ...
   * @default 'anchorEl'
   */
  anchorReference: import_prop_types44.default.oneOf(["anchorEl", "anchorPosition", "none"]),
  /**
   * A backdrop component. This prop enables custom backdrop rendering.
   ...
   * @default 16
   */
  marginThreshold: import_prop_types44.default.number,
  /**
   * Callback fired when the component requests to be closed.
   * The `reason` parameter can optionally be used to control the response to `onClose`.
   */
   ...
   * @default {}
   */
  PaperProps: import_prop_types44.default.shape({
    component: elementTypeAcceptingRef_default
  }),
  /**
   * The props used for each slot inside.
   ...
   * }
   */
  transformOrigin: import_prop_types44.default.shape({
    horizontal: import_prop_types44.default.oneOfType([import_prop_types44.default.oneOf(["center", "left", "right"]), import_prop_types44.default.number]).isRequired,
    vertical: import_prop_types44.default.oneOfType([import_prop_types44.default.oneOf(["bottom", "center", "top"]), import_prop_types44.default.number]).isRequired
  }),
  /**
...
var Menu = React63.forwardRef(function Menu2(inProps, ref) {
  const props = useDefaultProps({
    props: inProps,
    name: "MuiMenu"
  });
  ...
  let activeItemIndex = -1;
  React63.Children.map(children2, (child, index) => {
  ...
  return (0, import_jsx_runtime49.jsx)(MenuRoot, {
    onClose,
    anchorOrigin: {
      vertical: "bottom",
    ...
    children: (0, import_jsx_runtime49.jsx)(ListSlot, {
...
true ? Menu.propTypes = {
   ...
   */
  anchorEl: import_prop_types45.default.oneOfType([HTMLElementType, import_prop_types45.default.func]),
  /**
   ...
   * @default false
   */
  disableAutoFocusItem: import_prop_types45.default.bool,
  /**
   * Props applied to the [`MenuList`](https://mui.com/material-ui/api/menu-list/) element.
   * @deprecated use the `slotProps.list` prop instead. This prop will be removed in a future major release. See [Migrating from deprecated APIs](https://mui.com/material-ui/migration/migrating-from-deprecated-apis/) for more details.
   * @default {}
   */
  MenuListProps: import_prop_types45.default.object,
  /**
   * Callback fired when the component requests to be closed.
   *
   * @param {object} event The event source of the callback.
   ...
   */
  PopoverClasses: import_prop_types45.default.object,
  /**
   * The props used for each slot inside.
   * @default {}
   */
  slotProps: import_prop_types45.default.shape({
    ...
    list: import_prop_types45.default.oneOfType([import_prop_types45.default.func, import_prop_types45.default.object]),
  ...
  slots: import_prop_types45.default.shape({
    ...
    list: import_prop_types45.default.elementType,
...
var MenuItem = React64.forwardRef(function MenuItem2(inProps, ref) {
  ...
  return (0, import_jsx_runtime50.jsx)(ListContext_default.Provider, {
    value: childContext,
    children: (0, import_jsx_runtime50.jsx)(MenuItemRoot, {
      ref: handleRef,
      role,
      tabIndex,
      component,
...
function NotchedOutline(props) {
  ...
  return (0, import_jsx_runtime51.jsx)(NotchedOutlineRoot, {
    "aria-hidden": true,
    className,
    ownerState,
    ...other,
    children: (0, import_jsx_runtime51.jsx)(NotchedOutlineLegend, {
      ...
      children: withLabel ? (0, import_jsx_runtime51.jsx)("span", {
        ...
        // notranslate needed while Google Translate will not fix zero-width space issue
        _span3 || (_span3 = (0, import_jsx_runtime51.jsx)("span", {
          className: "notranslate",
          "aria-hidden": true,
          children: "​"
        }))
...
var OutlinedInput = React66.forwardRef(function OutlinedInput2(inProps, ref) {
  var _React$Fragment;
  const props = useDefaultProps({
    props: inProps,
    name: "MuiOutlinedInput"
  ...
  return (0, import_jsx_runtime52.jsx)(InputBase_default, {
    slots: {
      root: RootSlot,
      input: InputSlot
    },
    renderSuffix: (state) => (0, import_jsx_runtime52.jsx)(NotchedOutlineRoot2, {
      ...
      label: label != null && label !== "" && fcs.required ? _React$Fragment || (_React$Fragment = (0, import_jsx_runtime52.jsxs)(React66.Fragment, {
        children: [label, " ", "*"]
      })) : label,
...
var NativeSelectInput = React67.forwardRef(function NativeSelectInput2(props, ref) {
  const {
    className,
    disabled,
    error,
  ...
  return (0, import_jsx_runtime53.jsxs)(React67.Fragment, {
    children: [(0, import_jsx_runtime53.jsx)(NativeSelectSelect, {
      ownerState,
      className: clsx_default(classes.select, className),
      disabled,
      ref: inputRef || ref,
      ...other
    }), props.multiple ? null : (0, import_jsx_runtime53.jsx)(NativeSelectIcon, {
      as: IconComponent,
      ownerState,
...
var SelectInput = React68.forwardRef(function SelectInput2(props, ref) {
  const {
    "aria-describedby": ariaDescribedby,
  ...
  const displayRef = React68.useRef(null);
  const [displayNode, setDisplayNode] = React68.useState(null);
  const {
    current: isOpenControlled
  } = React68.useRef(openProp != null);
  const [menuMinWidthState, setMenuMinWidthState] = React68.useState();
  const handleRef = useForkRef_default(ref, inputRefProp);
  const handleDisplayRef = React68.useCallback((node) => {
  ...
  React68.useImperativeHandle(handleRef, () => ({
    focus: () => {
  ...
  const childrenArray = React68.Children.toArray(children2);
  const handleChange = (event) => {
  ...
  return (0, import_jsx_runtime54.jsxs)(React68.Fragment, {
    children: [(0, import_jsx_runtime54.jsx)(SelectSelect, {
      as: "div",
      ...
      children: isEmpty2(display) ? (
        // notranslate needed while Google Translate will not fix zero-width space issue
        _span4 || (_span4 = (0, import_jsx_runtime54.jsx)("span", {
          className: "notranslate",
          "aria-hidden": true,
          children: "​"
        }))
      ) : display
    }), (0, import_jsx_runtime54.jsx)(SelectNativeInput, {
      "aria-invalid": error,
      ...
      ...other,
      ownerState
    }), (0, import_jsx_runtime54.jsx)(SelectIcon, {
      as: IconComponent,
      className: classes.icon,
      ownerState
    }), (0, import_jsx_runtime54.jsx)(Menu_default, {
      id: `menu-${name || ""}`,
...
var Select = React69.forwardRef(function Select2(inProps, ref) {
  const props = useDefaultProps({
    name: "MuiSelect",
    props: inProps
  });
  ...
  const InputComponent = input || {
    standard: (0, import_jsx_runtime55.jsx)(StyledInput, {
      ownerState
    }),
    outlined: (0, import_jsx_runtime55.jsx)(StyledOutlinedInput, {
      label,
      ownerState
    }),
    filled: (0, import_jsx_runtime55.jsx)(StyledFilledInput, {
      ownerState
    })
  }[variant];
  const inputComponentRef = useForkRef_default(ref, getReactElementRef(InputComponent));
  return (0, import_jsx_runtime55.jsx)(React69.Fragment, {
    children: React69.cloneElement(InputComponent, {
...
var Skeleton = React70.forwardRef(function Skeleton2(inProps, ref) {
  const props = useDefaultProps({
    props: inProps,
    name: "MuiSkeleton"
  });
  ...
  return (0, import_jsx_runtime56.jsx)(SkeletonRoot, {
    as: component,
    ref,
    className: clsx_default(classes.root, className),
    ownerState,
...
var Tooltip = React71.forwardRef(function Tooltip2(inProps, ref) {
  ...
  const children2 = React71.isValidElement(childrenProp) ? childrenProp : (0, import_jsx_runtime57.jsx)("span", {
    children: childrenProp
  });
  const theme = useTheme();
  const isRtl = useRtl();
  ...
  return (0, import_jsx_runtime57.jsxs)(React71.Fragment, {
    children: [React71.cloneElement(children2, childrenProps), (0, import_jsx_runtime57.jsx)(PopperSlot, {
...
true ? Tooltip.propTypes = {
  ...
  slotProps: import_prop_types53.default.shape({
    arrow: import_prop_types53.default.oneOfType([import_prop_types53.default.func, import_prop_types53.default.object]),
    popper: import_prop_types53.default.oneOfType([import_prop_types53.default.func, import_prop_types53.default.object]),
    tooltip: import_prop_types53.default.oneOfType([import_prop_types53.default.func, import_prop_types53.default.object]),
...
var TableCell = React74.forwardRef(function TableCell2(inProps, ref) {
  const props = useDefaultProps({
    props: inProps,
    name: "MuiTableCell"
  });
  ...
  const table = React74.useContext(TableContext_default);
  const tablelvl2 = React74.useContext(Tablelvl2Context_default);
...
var Toolbar = React75.forwardRef(function Toolbar2(inProps, ref) {
  const props = useDefaultProps({
    props: inProps,
    name: "MuiToolbar"
  });
...
var KeyboardArrowLeft_default = createSvgIcon((0, import_jsx_runtime60.jsx)("path", {
...
var KeyboardArrowRight_default = createSvgIcon((0, import_jsx_runtime61.jsx)("path", {
...
var TablePaginationActions = React80.forwardRef(function TablePaginationActions2(props, ref) {
  const {
    backIconButtonProps,
    count,
    disabled = false,
  ...
  return (0, import_jsx_runtime64.jsxs)("div", {
    ref,
    ...other,
    children: [showFirstButton && (0, import_jsx_runtime64.jsx)(FirstButtonSlot, {
      onClick: handleFirstPageButtonClick,
      disabled: disabled || page === 0,
      "aria-label": getItemAriaLabel("first", page),
      title: getItemAriaLabel("first", page),
      ...firstButtonSlotProps,
      children: isRtl ? (0, import_jsx_runtime64.jsx)(LastButtonIcon, {
        ...slotProps.lastButtonIcon
      }) : (0, import_jsx_runtime64.jsx)(FirstButtonIcon, {
        ...slotProps.firstButtonIcon
      })
    }), (0, import_jsx_runtime64.jsx)(PreviousButtonSlot, {
      ...
      children: isRtl ? (0, import_jsx_runtime64.jsx)(NextButtonIcon, {
        ...slotProps.nextButtonIcon
      }) : (0, import_jsx_runtime64.jsx)(PreviousButtonIcon, {
        ...slotProps.previousButtonIcon
      })
    }), (0, import_jsx_runtime64.jsx)(NextButtonSlot, {
      ...
      children: isRtl ? (0, import_jsx_runtime64.jsx)(PreviousButtonIcon, {
        ...slotProps.previousButtonIcon
      }) : (0, import_jsx_runtime64.jsx)(NextButtonIcon, {
        ...slotProps.nextButtonIcon
      })
    }), showLastButton && (0, import_jsx_runtime64.jsx)(LastButtonSlot, {
      onClick: handleLastPageButtonClick,
      disabled: disabled || page >= Math.ceil(count / rowsPerPage) - 1,
      "aria-label": getItemAriaLabel("last", page),
      title: getItemAriaLabel("last", page),
      ...lastButtonSlotProps,
      children: isRtl ? (0, import_jsx_runtime64.jsx)(FirstButtonIcon, {
        ...slotProps.firstButtonIcon
      }) : (0, import_jsx_runtime64.jsx)(LastButtonIcon, {
        ...slotProps.lastButtonIcon
      })
    })]
  });
...
var TablePagination = React81.forwardRef(function TablePagination2(inProps, ref) {
  ...
  return (0, import_jsx_runtime65.jsx)(RootSlot, {
    ...rootSlotProps,
    children: (0, import_jsx_runtime65.jsxs)(ToolbarSlot, {
      ...toolbarSlotProps,
      children: [(0, import_jsx_runtime65.jsx)(SpacerSlot, {
        ...spacerSlotProps
      }), rowsPerPageOptions.length > 1 && (0, import_jsx_runtime65.jsx)(SelectLabelSlot, {
        ...selectLabelSlotProps,
        children: labelRowsPerPage
      }), rowsPerPageOptions.length > 1 && (0, import_jsx_runtime65.jsx)(SelectSlot, {
        variant: "standard",
        ...!selectProps.variant && {
          input: _InputBase || (_InputBase = (0, import_jsx_runtime65.jsx)(InputBase_default, {}))
        },
        value: rowsPerPage,
        ...
        disabled,
        ...selectSlotProps,
        children: rowsPerPageOptions.map((rowsPerPageOption) => (0, import_react6.createElement)(MenuItemSlot, {
          ...menuItemSlotProps,
          key: rowsPerPageOption.label ? rowsPerPageOption.label : rowsPerPageOption,
          value: rowsPerPageOption.value ? rowsPerPageOption.value : rowsPerPageOption
        }, rowsPerPageOption.label ? rowsPerPageOption.label : rowsPerPageOption))
      }), (0, import_jsx_runtime65.jsx)(DisplayedRows, {
        ...displayedRowsProps,
      ...
      }), (0, import_jsx_runtime65.jsx)(ActionsComponent, {
...
var TextField = React82.forwardRef(function TextField2(inProps, ref) {
  ...
  const InputElement = (0, import_jsx_runtime66.jsx)(InputSlot, {
  ...
  return (0, import_jsx_runtime66.jsxs)(RootSlot, {
    ...rootProps,
    children: [label != null && label !== "" && (0, import_jsx_runtime66.jsx)(InputLabelSlot, {
      htmlFor: id,
      id: inputLabelId,
      ...inputLabelProps,
      children: label
    }), select ? (0, import_jsx_runtime66.jsx)(SelectSlot, {
      "aria-describedby": helperTextId,
      id,
      ...
      ...selectProps,
      children: children2
    }) : InputElement, helperText && (0, import_jsx_runtime66.jsx)(FormHelperTextSlot, {
      id: helperTextId,
      ...formHelperTextProps,
      children: helperText
    })]
...
react-is/cjs/react-is.development.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-PY2RNV23.js.map
