...
function useCurrentColorScheme(options) {
  ...
  const modeStorage = React32.useMemo(() => storageManager?.({
    key: modeStorageKey,
    storageWindow
  }), [storageManager, modeStorageKey, storageWindow]);
  const lightStorage = React32.useMemo(() => storageManager?.({
    key: `${colorSchemeStorageKey}-light`,
    storageWindow
  }), [storageManager, colorSchemeStorageKey, storageWindow]);
  const darkStorage = React32.useMemo(() => storageManager?.({
...
@mui/system/esm/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-2CDH6DAW.js.map
